...
const ProductDetail = () => {
  ...
  const handleBack = () => {
    ...
    if (referrer) {
      console.log('🔄 Using referrer data for navigation');
      console.log('🔄 Scroll position to restore:', referrer.scrollPosition);
      console.log('🔄 Restoring to URL:', referrer.pathname + referrer.search);
