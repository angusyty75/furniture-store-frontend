...
Write-Host "📍 Frontend Port: 4173" -ForegroundColor Yellow  
Write-Host "🔗 Backend API: Port 8080 (Azure MySQL)" -ForegroundColor Yellow
Write-Host "☁️  Database: Azure MySQL" -ForegroundColor Yellow
...
try {
    ...
    Write-Host "💡 Start backend with: .\start-prod.ps1 (in backend folder)" -ForegroundColor Cyan
...
Write-Host "" -ForegroundColor White
Write-Host "🏭 Environment: PRODUCTION (Azure MySQL)" -ForegroundColor Red
