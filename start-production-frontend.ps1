# Production Frontend Startup (Connects to Backend Port 8080)
Write-Host "🎨 FURNITURE STORE - PRODUCTION FRONTEND" -ForegroundColor Magenta
...
# Set environment variables to use Vite proxy (connects to backend port 8080)
...
try {
    ...
    Write-Host "   Sample product: $($response[0].nameEn)" -ForegroundColor White
} catch {
